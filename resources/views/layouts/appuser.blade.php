        ...
        <div class="layout-container">
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item">
                        <a href="{{ route('pemberkasanuser.index') }}" class="menu-link mb-2">
                            <i class="menu-icon tf-icons bx bx-folder"></i> <!-- Ikon folder untuk pemberkasan -->
                            <div class="text-truncate" data-i18n="pemberkasan">Pemberkasan</div>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a href="{{ route('perhitungansaw.index') }}" class="menu-link mb-2">
                            <i class="menu-icon tf-icons bx bx-calculator"></i>
                            <div class="text-truncate" data-i18n="perhitungansaw">Detail Penilaian</div>
                        </a>
                    </li>
                </ul>
            </aside>
                    ...
                    <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
                        <div class="navbar-nav align-items-center">
                            <div class="nav-item d-flex align-items-center">
                                <div class="avatar avatar-online d-flex justify-content-center align-items-center" style="width: 40px; height: 40px;">
